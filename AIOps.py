...
# Static variables
JENKINS_URL = "http://192.168.1.131:32000"  # Jenkins URL
JOB_NAME = "AIOps"  # Jenkins job name
USERNAME = "eslammohamed"  # Jenkins username
API_TOKEN = "1108645f325a6af768bbaa00d2aea8a8ea"  # Jenkins API token
...
# put the correct jenkins file here(local_jenkinsfile_path)
    try:
        ...
        openai.api_key = "sk-sae-we-yHodfv15Vh34YUrZgo8ET3BlbkFJYnI1U9BhC9xFfpI7MGKc"
                                            ...
                                            with open(txt_file, "r") as file:
                                                ...
                                                for index, line in enumerate(lines): 
                                                    if re.search(pattern, line):
                                                        output += "".join(lines[max(0,index-2):index])
                                        #print(output)
                                        openai.api_key = "sk-sae-we-yHodfv15Vh34YUrZgo8ET3BlbkFJYnI1U9BhC9xFfpI7MGKc"
                                        result = openai.chat.completions.create(
                                            model = "gpt-3.5-turbo",
